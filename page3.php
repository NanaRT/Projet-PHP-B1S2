...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<title>Form@Cup Nous Contacter</title>
	</head>
	<body>
		...
		<div class="header">
			...
			<div class="navigation">
				<ul class="nav nav-tabs">
					...
					<li><a href="page1.php">Formations</a></li>
					<li><a href="page2.php">Ton profil</a></li>
					<li class="active"><a href="page3.php">Nous contacter</a></li>
				</ul>
			</div>
		</div>
